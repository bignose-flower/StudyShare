...
Subject.create(category: 'カテゴリーなし')
japanese_childs = ['現代文', '古文', '漢文', '小論文']

japanese_grandchilds = [['全て','説明文','随筆','小説','詩・俳句','慣用句・熟語'],['全て','現代語訳','品詞','動詞','形容詞','格助詞・助動詞', '敬語', '単語', '読解'],['全て','訓読','書き下し','再読文字','否定','句法', '疑問形', '反語', '過去形', '敬語', '読解'],['全て']]
...
parent = Subject.create(category: '数学')
...
parent = Subject.create(category: '理科')
...
parent = Subject.create(category: '社会')
